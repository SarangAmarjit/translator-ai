...
class APIs {
  ...
  static Future<String> getAnswer(String question) async {
    try {
      final model = GenerativeModel(
        ...
        apiKey: 'AIzaSyCTNHgQMlV_BVovxhlzpXaj4-OUY61L2Xw',
      );
  ...
  static Future<String> googleTranslate(
    ...
    try {
      ...
      log("res.sourceLanguage : ${res.sourceLanguage}");
      log("res.source : ${res.source}");
      log("res.targetLanguage : ${res.targetLanguage}");
      return res.text;
    } catch (e) {
